 ...
 *
 * this is a copy from google source,
 * In order to fixed crash,
 * so modify 'ft.commit' to 'ft.commitAllowingStateLoss()'
 */
...
public class FragmentTabHost extends TabHost
    ...
    static {
        ...
        if (version >= 21) {
            IMPL = new FragmentTabHost.LayoutCompatImplApi21();
        } else {
            IMPL = new FragmentTabHost.LayoutCompatImplBase();
        }
    }
